...
When possible use a dedicated physical network interface for your tunnels
...
#.   libvirt-bin (1.2.12-0ubuntu9~cloud0~mq1)
#.   qemu (2.1+dfsg-4ubuntu6.4+6wind3)
#.   qemu-kvm (2.1+dfsg-4ubuntu6.4+6wind3)
...
correct packages and replace the Mirantis ones in the early stages of deployment.
